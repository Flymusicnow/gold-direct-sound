...
import { AchievementActionSheet } from "./AchievementActionSheet";
    ...
    <>
      ...
      >
        <Card
          ...
          className={cn(
            "p-4 transition-all duration-300 relative overflow-hidden group cursor-pointer",
            unlocked
              ? "bg-gradient-to-br from-primary/20 via-primary/10 to-transparent border-primary/30 shadow-gold hover:shadow-gold-lg"
              : "bg-card/20 backdrop-blur border-border/30 opacity-60 hover:opacity-80"
          )}
        >
