...
export function EditMerchDialog({ product, onClose, onSuccess }: EditMerchDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: "Merch product updated successfully",
      });
  ...
  return (
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Edit Merch Product</DialogTitle>
        </DialogHeader>
