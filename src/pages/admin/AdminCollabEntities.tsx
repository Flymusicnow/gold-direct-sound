...
import { Plus, Search, Building2, Music, Megaphone, Calendar, Edit, Trash2 } from 'lucide-react';
...
export default function AdminCollabEntities() {
  ...
  if (loading) {
    return (
      <AdminLayout title="Collab Entities" description="Manage brands, festivals, sponsors & agencies">
