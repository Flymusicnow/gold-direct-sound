...
import { Music, Heart, Mic2, Users } from "lucide-react";
...
export default function RoleSelection() {
  ...
  const handleContinue = async () => {
    ...
    setLoading(true);
    try {
      const rolesToInsert = bothRoles 
        ? [{ user_id: user.id, role: 'artist' as const }, { user_id: user.id, role: 'fan' as const }]
        : [{ user_id: user.id, role: selectedRole as 'artist' | 'fan' }];
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-b from-background to-background/50">
      <div className="w-full max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <Card
            className={`p-8 cursor-pointer transition-all hover:border-primary/50 ${
          ...
          >
            <div className="text-center space-y-4">
              ...
              <h2 className="text-2xl font-bold">I'm an Artist</h2>
              <p className="text-muted-foreground">
                Upload music, manage your career, and connect directly with your fans
              </p>
          ...
          >
            <div className="text-center space-y-4">
              ...
              <h2 className="text-2xl font-bold">I'm a Fan</h2>
              <p className="text-muted-foreground">
